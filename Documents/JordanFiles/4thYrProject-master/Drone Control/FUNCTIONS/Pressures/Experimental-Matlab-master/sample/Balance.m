% Balance Gibbons rig by logging once per rev and accelerometer

clear
close all
clc

% Load iGibbons variables
iGibbons
...
th_trial = 0; mass_trial = 3.37;
% th_trial = 180; mass_trial = 1.2;
rpm = 1000;

% Calculated factors for the Gibbons at 1500 rpm
% r_calib = 4.3598; ph_trial = -151.7673;
