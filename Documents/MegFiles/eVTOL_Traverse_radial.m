%   eVTOL_Traverse_radial                                
%                               
%   A script to run radial traverses on the eVTOL rig
%
...
park.d = [784615 784615 784615 784615];
park.c = [0 0 0 0];
park.limit = [0 240000  ;0 240000; -59000 553000 ; -100000 240000];
park.type = 'RT';
dir_type = 'radial';

% Meridional radii measured from casing
r_hub = 0.065; r_cas = 0 ; r_mid = 0.5 * (r_hub + r_cas);
...
% Radial points distribution for fine full span traverse
 nj = 20; nk = 1; ni = 1; Iota = 0; i=1;
 r_min = r_cas;
 r_max = r_hub; r_fac = 0.15;
 t_min =0; t_max = 0;
