...
% - D.rpms
% - D.Nr:   number of rotor blades
% - D.Ns:   number of stator blades
...
subplot(2,4,1)
contourf(phis,sigmas,D.etas,25, 'edgecolor','none'); colorbar; caxis(caxis); hold on;
contour(phis,sigmas,D.DH1,25, 'r:', 'LineWidth',1.1);
...
subplot(2,4,6)
contourf(phis,sigmas,D.Nr,25, 'edgecolor','none'); colorbar; caxis(lim.Nb);
title("Rotor blades"); xlabel("\phi"); ylabel("\sigma");
% text(1.1,1.3, ['CRDF = ' num2str(CRDF_flag)],'color','b')
subplot(2,4,7)
contourf(phis,sigmas,D.Ns,25, 'edgecolor','none'); colorbar; caxis(lim.Nb);
...
hold on;
contour(phis,sigmas,D.DH1, [0.72 0.72], 'r--', 'LineWidth',2);
contour(phis,sigmas,D.L_eta,25, 'r:', 'LineWidth',1.5);
...
subplot(2,3,5)
contourf(phis,psis,D.Nr,25, 'edgecolor','none'); colorbar; caxis(lim.Nb);
title("Rotor blades"); xlabel("\phi"); ylabel("\psi");
subplot(2,3,6)
contourf(phis,psis,D.Ns,25, 'edgecolor','none'); colorbar; caxis(lim.Nb);
